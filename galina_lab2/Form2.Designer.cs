...
namespace galina_lab2
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Нажмите на кнопку, чтобы узнать результат";
            ...
            this.button1.Location = new System.Drawing.Point(281, 252);
            ...
            this.Name = "Form2";
            this.Text = "Ваш результат, отобразиться после нажатия на кнопку";
